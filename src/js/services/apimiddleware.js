(function (angular) {
    'use strict';
    angular.module('FileManagerApp').service('apiMiddleware', ['$window', 'fileManagerConfig', 'apiHandler', 'UserService',
        function ($window, fileManagerConfig, ApiHandler, UserService) {
            ...
            ApiMiddleware.prototype.createUserFolder = function (user) {
                var path = '/' + user.group + '/' + user.username;
