(function (angular, $) {
    ...
    angular.module('FileManagerApp').controller('FileManagerCtrl', [
        '$scope', '$rootScope', '$window', '$translate', 'fileManagerConfig', 'item', 'fileNavigator', 'apiMiddleware', 'UserService', 'AuthenticationService', '$location',
        function ($scope, $rootScope, $window, $translate, fileManagerConfig, Item, FileNavigator, ApiMiddleware, UserService, AuthenticationService, $location) {
                ...
                if ($rootScope.globals.currentUser) {
                    UserService.GetByUsername($rootScope.globals.currentUser.username)
                        .then(function (user) {
                            ...
                            // fileManagerConfig.basePath = '/' + user.group + '/' + user.username;
                            console.log(fileManagerConfig.basePath);
                            $scope.fileNavigator = new FileNavigator();
                            $scope.fileNavigator.refresh();
                        });
                };
